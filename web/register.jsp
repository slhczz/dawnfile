...
<div id="main">
    <div class="container">
        <div id="register">
            <h1>注册</h1>
            <form action="/dawnfile/register" method="post" onsubmit="return register()">
                <table class="form">
                    <tbody><tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" name="terms" value="agree" id="check">
                                <span>我已阅读并同意<a href="#" class="green">《网站服务条款》</a>。</span>
                            </label>
                        </td>
                    </tr>
                    <tr>
